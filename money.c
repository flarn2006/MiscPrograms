...
int main(int argc, char *argv[])
{
	...
	if (bills100)
		printf("%d $100 bills\t= $%.2lf\n", bills100, bills100 * 100.00);
	if (bills50)
		printf("%d $50 bills\t= $%.2lf\n", bills50, bills50 * 50.00);
	if (bills20)
		printf("%d $20 bills\t= $%.2lf\n", bills20, bills20 * 20.00);
	if (bills10)
		printf("%d $10 bills\t= $%.2lf\n", bills10, bills10 * 10.00);
	if (bills5)
		printf("%d $5 bills\t= $%.2lf\n", bills5, bills5 * 5.00);
	if (bills1)
		printf("%d $1 bills\t= $%.2lf\n", bills1, (double)bills1);
	if (quarters)
		printf("%d quarters\t= $%.2lf\n", quarters, quarters * 0.25);
	if (dimes)
		printf("%d dimes\t\t= $%.2lf\n", dimes, dimes * 0.10);
	if (nickels)
		printf("%d nickels\t= $%.2lf\n", nickels, nickels * 0.05);
	if (pennies)
		printf("%d pennies\t= $%.2lf\n", pennies, pennies * 0.01);
